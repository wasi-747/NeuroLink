  ...
  const testimonials = [
    {
      ...
      quote:
        "NeuroVerse's anonymous forum was a lifesaver during finals week. Knowing I wasn't the only one struggling with extreme anxiety completely changed my perspective.",
    ...
    },
    {
      ...
      quote:
        "The teletherapy feature is incredibly seamless. I found a therapist who specifically understands the pressure of thesis deadlines. It's been transformative.",
    ...
    },
    {
      ...
      role: "NSU",
      quote:
        "I use the daily mood tracker and journal every night. The 'Overcoming Anxiety' course gave me actual, practical tools I use every day before rounds.",
  ...
  return (
    <div className="py-24 bg-slate-900 text-white overflow-hidden relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <h2 className="text-brand-400 font-bold tracking-wider uppercase text-sm mb-3">
            Student Stories
          </h2>
          ...
          <p className="text-lg text-slate-400 font-medium">
            Hear from students who have found balance, resilience, and community
          ...
          {testimonials.map((testimonial, idx) => (
            ...
            >
              ...
              <div className="flex items-center gap-4 mt-auto">
                <div
                  className={`w-12 h-12 rounded-full flex items-center justify-center font-bold text-lg ${testimonial.avatar}`}
                >
