...
const BookingModal = ({ isOpen, onClose, therapist }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center sm:p-4 bg-slate-900/50 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-white w-full h-full sm:h-auto sm:max-h-[90vh] overflow-y-auto sm:rounded-3xl max-w-xl shadow-2xl animate-in zoom-in-95 duration-200 flex flex-col">
