...
const CreatePostForm = ({ isOpen, onClose, onSubmit }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center sm:p-4 bg-slate-900/50 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-white w-full h-full sm:h-auto sm:max-h-[90vh] overflow-y-auto sm:rounded-3xl max-w-2xl shadow-2xl animate-in zoom-in-95 duration-200 flex flex-col">
        <div className="p-6 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
          <div>
            ...
            <p className="text-sm text-slate-500 font-medium mt-1">
              Your real identity will remain completely hidden.
            </p>
          </div>
          <button
            onClick={onClose}
        ...
        >
          ...
          <div>
            <div className="flex justify-between items-end mb-2">
              ...
              <span
                className={`text-xs font-semibold ${contentValue.length > 950 ? "text-red-500" : "text-slate-400"}`}
              >
