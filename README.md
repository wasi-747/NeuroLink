...
Follow these steps to run NeuroVerse locally on your machine.
...
- Admin: `admin@neuroverse.com` (Password: `password123`)
- Therapist: `sarah@neuroverse.com` (Password: `password123`)
...
NeuroVerse features a rigorous mobile-first design philosophy. Key responsive decisions include:
